...
export default function PatientView({ patientId, setShowDirectory }) {

  const queryClient = useQueryClient();

  const patient = useQuery(['patient', patientId], () => getClient(patientId));

  if (patient.isError || patient.isLoading) {
    return <div></div>
  }
  ...
  return (
    <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none xl:order-last">
      ...
      <article>
        ...
        <div>
          <div>
            <img className="h-32 w-full object-cover lg:h-48" src={patient.data?.imageUrl} alt="" />
          </div>
            ...
            <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
              <div className="flex">
                <img
                  ...
                  src={patient.data?.imageUrl}
                  alt=""
                />
              </div>
              <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                <div className="sm:hidden 2xl:block mt-6 min-w-0 flex-1">
                  <h1 className="text-2xl font-bold text-gray-900 truncate">{patient.data.firstName} {patient.data.lastName}</h1>
                </div>
        ...
        <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          <div>
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Review the frequency and quality of this patients activity sessions...
              </p>
            </div>
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <textarea
                    ...
                    defaultValue={''}
                  />
                  <p className="mt-2 text-sm text-gray-500">Write down notes about the patient.</p>
                </div>
              </div>
          ...
          <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">This is the patients personal information.</p>
            </div>
